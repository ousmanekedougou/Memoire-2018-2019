...
<hr>
              <p class="text-muted">
                <span class="text-primary text-bold"><i class="fa fa-map-marker"></i> Adresse :</span>  {{ $profile->adresse }}
              </p>
<hr>
              <p class="text-muted">
                <span class="text-primary text-bold"><i class="fa fa-calendar"></i> Naissance :</span>  {{ $profile->date }}
              </p>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <form action="{{ route('update_client',$profile->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="adresse" value="{{ $profile->adresse }}" type="text" class="form-control @error('adresse') is-invalid @enderror"  id="inputSkills" placeholder="">
                        @error('adresse')
                          <span class="invalid-feedback" role="alert">
                              <strong class="message_error">{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group">
                    <label for="inputSkills" class="col-sm-2 control-label">Naissance</label>

                    <div class="col-sm-10">
                      <input name="date" value="{{ $profile->date }}" type="date" class="form-control @error('date') is-invalid @enderror"  id="inputSkills" placeholder="">
                        @error('date')
                          <span class="invalid-feedback" role="alert">
                              <strong class="message_error">{{ $message }}</strong>
                          </span>
