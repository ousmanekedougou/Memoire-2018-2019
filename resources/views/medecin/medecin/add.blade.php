...
<div class="box-body">
  <div class="register-box-body col-lg-6 col-lg-offset-3">
    <p class="login-box-msg">Enregistre Un Nouveau Medecin</p>
      ...
      <form action="{{ route('medecin-show.store') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="row">
...
<div class="col-md-6">
      ...
      <div class="form-group has-feedback">
        <select class="form-control  @error('hopital') is-invalid @enderror" value="{{ old('hopital') }}"  name="hopital"
            style="width: 100%;">
      ...
      <div class="form-group has-feedback">
        <select class="form-control select2 @error('disponibilite[]') is-invalid @enderror" value="{{ old('disponibilite[]') }}"  name="disponibilite[]" multiple="multiple" data-placeholder="Selectioner votre disponibilite"
            style="width: 100%;">
            @foreach($disponibilite as $dipo)
            <option value="{{ $dipo->id }}">{{ $dipo->jour }}</option>
            @endforeach
        </select>
        <span class="glyphicon glyphicon form-control-feedback"></span>
        @error('disponibilite')
