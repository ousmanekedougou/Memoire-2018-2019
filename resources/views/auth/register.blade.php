@extends('user.layouts.app',['title' => 'S\'inscrire'])
@section('main-content')
<!-- style="background-image: url('{{asset('user/images/bg_1.jpg')}}');" -->
	<section class="hero-wrap hero-wrap-2"  data-stellar-background-ratio="0.5">
<!-- <div class="slider-item" style="background-image:url(user/images/register.jpg);background-size:cover;background-position:center;background-repeat:no-repeat;width:100%;" data-stellar-background-ratio="0.5"> -->
<section class="hero-wrap hero-wrap-2" style="background-image: url('user/images/register.jpg');" data-stellar-background-ratio="0.5">
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" data-stellar-background-ratio="0.5" style="background-color:rgba(0, 0, 0, 0.007) ;">
    	<div class="container">
			...
			<div class="col-lg-2"></div>
    			<div class="col-lg-8 py-5 pr-md-5  form-create">
					<div class="heading-section heading-section-white ftco-animate mb-5">
						<span class="subheading" style="margin-left:30px;">Inscription</span>
						<h2 class="mb-4" style="margin-left:30px;">Une Consultation Fiable</h2>
						<p></p>
					</div>
	          		<form action="{{ route('register') }}" method="POST" class="appointment-form ftco-animate">
                    	@csrf
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					<input type="text" class="form-control @error('prenom') is-invalid @enderror text-black" name="prenom" placeholder="Prenom" >
                                @error('prenom')
						...
						<div class="form-group ml-md-4">
							<button type="submit" class="btn btn-primary py-3 px-4"> <span class="icon-user"></span>  Creer Le Compte</button>
						</div>
	    				</div>
	    			</form>
    			</div>
			<div class="col-lg-2"></div>
    			...
    			<!-- <div class="col-lg-6 p-5 bg-counter aside-stretch">
						...
						<h1 style="text-align:center;margin-left:150px;margin-top:100px;font-size:4em;font-weigth:900;" >
							Google Map
					</h1>
