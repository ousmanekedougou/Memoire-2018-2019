                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      @if($ticker_client->prix  == $ticker_client->medecin->prix)
                        ...
                        @else 
                        <span class="pull-left">Payer votre ticker ici </span> 
                      <span class="pull-right"> <a href="{{ route('payment.index') }}" class="btn btn-primary btn-xs"> <i class="fa fa-money"></i> Passer a la Caisse </a> </span>
                        @endif
                      </p>
                    </div>
                  </div>
