        ...
        <div class=" box-primary">
            ...
            @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Le Lien du reseau</label>
                  <input type="text" name="lien" value="{{ old('lien') }}" class="form-control form-control @error('lien') is-invalid @enderror" id="exampleInputPassword1" placeholder="">
                  @error('lien')
                    <span class="invalid-feedback" role="alert">
                        <strong class="message_error">{{ $message }}</strong>
                    </span>
