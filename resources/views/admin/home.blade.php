        ...
        <div class="">
          <div class="nav-tabs-custom">
            ...
            <li class="active"><a href="#activity" data-toggle="tab">Dakar</a></li>
              <li ><a href="#kaolack" data-toggle="tab">Kaolack</a></li>
              <li><a href="#kedougou" data-toggle="tab">Kedougou</a></li>
              <li><a href="#tamba" data-toggle="tab">Tamba</a></li>
              <li><a href="#diourbel" data-toggle="tab">Diourbel</a></li>
              <li><a href="#louga" data-toggle="tab">Louga</a></li>
              <li><a href="#Saint-louis" data-toggle="tab">St louis</a></li>
              <li><a href="#matame" data-toggle="tab">Matame</a></li>
              <li><a href="#sediou" data-toggle="tab">Sediou</a></li>
              <li><a href="#kolda" data-toggle="tab">Kolda</a></li>
              <li><a href="#ziguinchore" data-toggle="tab">Ziguinchore</a></li>
              <li><a href="#fatick" data-toggle="tab">Fatick</a></li>
              <li><a href="#thies" data-toggle="tab">Thies</a></li>
              <li><a href="#kaffrine" data-toggle="tab">Kaffrine</a></li>
            </ul>
                          ...
                          <div class="box box-widget">
                            <div class="box-body">
                              ...
                              <div class="pull-right">
                                <!-- <a class="btn btn-info btn-xs" href="{{ route('medecin.edit',$medecin->id) }}" style="margin-right:20px;"><i class="fa fa-edit"></i> Modifier</a> -->
                                <a class="btn btn-warning btn-xs " href="{{ route('medecin.show',$medecin->id) }}" style="margin-right:20px;"><i class=" fa fa-eye"></i> Voire</a>
                              </div>
                            </div>
                          </div>
                        </div>
