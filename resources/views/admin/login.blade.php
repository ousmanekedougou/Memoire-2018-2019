...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ route('admin.login') }}"><b>Admin </b> Connexion</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
  <img src="{{ asset('user/images/login-admin.webp') }}" class="img-responsive img-circle" style="width:100px;height:105px;margin-left:110px;" alt="" srcset="">
