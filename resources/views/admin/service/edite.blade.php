    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class=" box-primary">
            ...
            <!-- form start -->
          <div class="box-body">
            <form role="form" action="{{ route('service.update',$service_edit->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            {{method_field('PATCH')}}

                  <div class="form-group">
                      <label for="exampleInputEmail1">Nom du service</label>
                      <input type="text" name="nom" value="{{ $service_edit->nom }}" class="form-control form-control @error('nom') is-invalid @enderror" id="exampleInputEmail1" placeholder="">
                        @error('nom')
            ...
            <div class="box-body pad">
                ...
                <textarea name="detail" id="editor1" class="" value="{{ old('detail') }}" class="form-control textarea @error('detail') is-invalid @enderror" placeholder="La description de votre service"
                  ...
                  {!! htmlspecialchars_decode($service_edit->detail) !!}
                  </textarea>
                  @error('detail')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
